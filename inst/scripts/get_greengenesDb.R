### =========================================================================
### Downloading database greengenes 13_8 85 OTU database
...
getGreenGenes13.8.85Db <- function(
        db_name = "gg_13_8_OTU85",
        seq_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/rep_set/85_otus.fasta",
        taxa_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/taxonomy/85_otu_taxonomy.txt",
        tree_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/trees/85_otus.tree"
){
